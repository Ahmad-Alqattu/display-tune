...
<p align="center">
  ...
  بواجهة GTK 4 / libadwaita أصلية بالعربية والإنجليزية.
</p>
...
- **واجهة عربية (من اليمين لليسار) وإنجليزية:** تتبع لغة النظام، ويمكن تغييرها من القائمة.
...
البلاغات وطلبات الدمج مرحّب بها، خصوصًا الاختبار على إصدارات وتوزيعات أخرى. لإضافة ترجمة، انسخ قسم `en` في [`display_tune/i18n.py`](display_tune/i18n.py) وأضف لغتك إلى `LANGUAGES`.
